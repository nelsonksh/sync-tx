...
-- CreateTable
CREATE TABLE "NetworkTxOutput" (
    "id" SERIAL NOT NULL,
    "utxoId" INTEGER NOT NULL,
    "validator" "NetworkValidator" NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "NetworkTxOutput_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "LocalStateTxOutput" (
    "id" SERIAL NOT NULL,
    "utxoId" INTEGER NOT NULL,
    ...
    CONSTRAINT "LocalStateTxOutput_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "NetworkTxOutput_validator_idx" ON "NetworkTxOutput"("validator");
...
-- AddForeignKey
ALTER TABLE "NetworkTxOutput" ADD CONSTRAINT "NetworkTxOutput_utxoId_fkey" FOREIGN KEY ("utxoId") REFERENCES "Utxo"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "LocalStateTxOutput" ADD CONSTRAINT "LocalStateTxOutput_utxoId_fkey" FOREIGN KEY ("utxoId") REFERENCES "Utxo"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
